"""
Complete Training Script for CheXpert DenseNet-121
Trains on full dataset with DICOM files, evaluates on validation set
"""
...
class DenseNetCheXpert(nn.Module):
    """DenseNet-121 for CheXpert multi-label classification"""
    ...
    def train(self, train_loader, val_loader, num_epochs=10):
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            if mean_auc > best_auc:
                ...
                print(f"\n  [OK] Saved best model (AUC: {mean_auc:.4f})")
...
def main():
    print("=" * 80)
    print("CheXpert DenseNet-121 Training")
    print("=" * 80)
